...
final class HomePageViewModel: ObservableObject {
    ...
    var selectedAssignment: Assignment = Assignment(name: "", Class: Class(name: "", professor: "", location: "", color: CodableColor(.white)), dueDate: Date(), priority: .low, info: "")
    ...
    @Published var selectedClass: Class = Class(name: "", professor: "", location: "", color: CodableColor(.white))
